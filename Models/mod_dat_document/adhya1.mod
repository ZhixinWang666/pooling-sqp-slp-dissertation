...
param poolcap {J};
param poolconn {I,J};  # raw-to-pool fraction upper bound, 0 or 1

param prod_lo {K};
param prod_up {K};
param prod_price {K};

param poolprodconn {J,K};    # pool-to-product connection, 0 or 1
param maxpoolprod {J,K};     # pool-to-product capacity

param rawcomp {I,Q} default 0;
param prodcomp_ub {K,Q} default Infinity;
